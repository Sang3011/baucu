App = {
    ...
    castVote: function() {
      var candidateId = $('#chuoi').val();
      var number = candidateId.match(/\d/g);
      number = number.join("");
      var tim1= number.indexOf(1);
      var tim2= number.indexOf(2);
      var tim3= number.indexOf(3);
      var tim4= number.indexOf(4);
      var tim5= number.indexOf(5);
      var a=1;
      var b=2;
      var c=3;
      var d=4;
      ...
      if(tim5==-1) e=0;
      App.contracts.baucu.deployed().then(function(instance) {
        return instance.vote(a,b,c,d,e, { from: App.account });    
    ...
    addCandidates: function() {
      ...
      App.contracts.baucu.deployed().then(function(instance) {
        return instance.addCandidate(name, gioitinh, tuoi, tomtat, { from: App.account });
      }).then(function(result) {
      $("#loader").show();
      $('#name').val('');
      $('#gioitinh').val('');
